...
public class Main {
	...
	public static void main(String[] args) {
        ...
        ThreadUtil.sleepSecs(1);
        ParticleFilter filter = new ParticleFilter(50, 1500, 0.5f, 0.8f, 0.2f, 20, 20, 5 * Constants.DegreeToRadian);
        PathPlanningUpdater pathUpdater = new PathPlanningUpdater(simulator, filter, 300);
        ThreadUtil.sleepSecs(1);
