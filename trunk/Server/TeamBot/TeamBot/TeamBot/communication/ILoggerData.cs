...
namespace Communication
{
    ...
    public partial class ByteData : Ice.ObjectImpl
    {
        ...
        protected override void writeImpl__(IceInternal.BasicStream os__)
        {
            ...
            Communication.byteSequenceHelper.write(os__, byteArrayData);
            os__.endWriteSlice();
        }
        ...
        {
            is__.startReadSlice();
            type = (Communication.DataTypeIce)is__.readEnum(6);
            timeStamp = is__.readLong();
            byteArrayData = Communication.byteSequenceHelper.read(is__);
            is__.endReadSlice();
        }
    ...
    public partial class FloatData : Ice.ObjectImpl
    {
        ...
        protected override void writeImpl__(IceInternal.BasicStream os__)
        {
            ...
            os__.writeEnum((int)type, 6);
            os__.writeLong(timeStamp);
            Communication.floatSequenceHelper.write(os__, floatArrayData);
            os__.endWriteSlice();
        }
        ...
        protected override void readImpl__(IceInternal.BasicStream is__)
        {
            ...
            type = (Communication.DataTypeIce)is__.readEnum(6);
            timeStamp = is__.readLong();
            floatArrayData = Communication.floatSequenceHelper.read(is__);
            is__.endReadSlice();
        }
...
namespace Communication
{
    ...
    public sealed class ILoggerDataPrxHelper : Ice.ObjectPrxHelperBase, ILoggerDataPrx
    {
        ...
        private void sendByteData(Communication.ByteData data, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitContext__)
        {
            ...
            Ice.Instrumentation.InvocationObserver observer__ = IceInternal.ObserverHelper.get(this, __sendByteData_name, context__);
            int cnt__ = 0;
            try
            {
                while(true)
                {
                    ...
                    try
                    {
                        ...
                        del__.sendByteData(data, context__, observer__);
                        return;
                    }
        ...
        private void sendFloatData(Communication.FloatData data, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitContext__)
        {
            ...
            Ice.Instrumentation.InvocationObserver observer__ = IceInternal.ObserverHelper.get(this, __sendFloatData_name, context__);
            int cnt__ = 0;
            try
            {
                while(true)
                {
                    ...
                    try
                    {
                        delBase__ = getDelegate__(false);
                        ILoggerDataDel_ del__ = (ILoggerDataDel_)delBase__;
                        del__.sendFloatData(data, context__, observer__);
                        return;
                    }
                    catch(IceInternal.LocalExceptionWrapper ex__)
                    {
...
namespace Communication
{
    ...
    {
        void sendByteData(Communication.ByteData data, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__);

        void sendFloatData(Communication.FloatData data, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__);
    }
}
...
namespace Communication
{
    ...
    {
        public void sendByteData(Communication.ByteData data, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__)
        {
            IceInternal.Outgoing og__ = handler__.getOutgoing("sendByteData", Ice.OperationMode.Idempotent, context__, observer__);
            try
            {
                try
                {
        ...
        public void sendFloatData(Communication.FloatData data, _System.Collections.Generic.Dictionary<string, string> context__, Ice.Instrumentation.InvocationObserver observer__)
        {
            IceInternal.Outgoing og__ = handler__.getOutgoing("sendFloatData", Ice.OperationMode.Idempotent, context__, observer__);
            try
            {
                try
                {
...
namespace Communication
{
    ...
    public abstract class ILoggerDataDisp_ : Ice.ObjectImpl, ILoggerData
    {
        ...
        public static Ice.DispatchStatus sendByteData___(ILoggerData obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            ...
            IceInternal.ParamPatcher<Communication.ByteData> data__PP = new IceInternal.ParamPatcher<Communication.ByteData>(Communication.ByteData.ice_staticId());
            is__.readObject(data__PP);
            is__.readPendingObjects();
            inS__.endReadParams();
            obj__.sendByteData(data__PP.value, current__);
        ...
        public static Ice.DispatchStatus sendFloatData___(ILoggerData obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.startReadParams();
            IceInternal.ParamPatcher<Communication.FloatData> data__PP = new IceInternal.ParamPatcher<Communication.FloatData>(Communication.FloatData.ice_staticId());
            is__.readObject(data__PP);
            is__.readPendingObjects();
            inS__.endReadParams();
            obj__.sendFloatData(data__PP.value, current__);
            inS__.writeEmptyParams__();
            return Ice.DispatchStatus.DispatchOK;
        }
