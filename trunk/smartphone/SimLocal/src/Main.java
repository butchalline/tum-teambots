...
public class Main {
	...
	public static void main(String[] args) {
        ...
        ThreadUtil.sleepSecs(1);
        ParticleFilter filter = new ParticleFilter(100, 1200, 0.5f, 0.8f, 0.2f, 20, 20, 5 * Constants.DegreeToRadian);
        PathPlanningUpdater pathUpdater = new PathPlanningUpdater(simulator, filter, filter, 60);
        ThreadUtil.sleepSecs(1);
